...
export class TimelinePage implements OnInit {
  ...
  post(post: any) {
    this.navController.navigateRoot(['/parent/nouveautes'], {
      queryParams: {
        post: post
      }
    });
    // this.router.navigate(['/parent/nouveautes'], {
    //   queryParams:{
    //     post : post
    //   }
    // });
  ...
  ressources(unite:any) {
    ...
    this.navController.navigateRoot(['/parent/ressource'],{
      queryParams: {
        unite: unite
      }
    });
  ...
  album(post: any) {
    ...
    this.navController.navigateRoot(['/parent/album-photo'], {
      queryParams: {
        post: post
      }
    });
  ...
  demandes(demande: any) {
    ...
    this.navController.navigateRoot(['/parent/demandes'],{
      queryParams: {
        resource: demande
      }
    });
  ...
  checkoutEnfant() {
    ...
    this.router.navigate(['/parent/checkout-enfant']);
  }
