...
@Component({
  selector: 'app-album-photo-item',
  templateUrl: './album-photo-item.page.html',
  styleUrls: ['./album-photo-item.page.scss'],
})
export class AlbumPhotoItemPage implements OnInit {
