...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'offres-emploie',
        loadChildren: () => import('../offres-emploie/offres-emploie.module').then( m => m.OffresEmploiePageModule)
      },
      {
        path: 'offre-emploie',
        loadChildren: () => import('../offre-emploie/offre-emploie.module').then( m => m.OffreEmploiePageModule)
      },
      {
        path: 'parcours-form',
        loadChildren: () => import('../parcours-form/parcours-form.module').then( m => m.ParcoursFormPageModule)
      },
      {
        path: 'experience-form',
        loadChildren: () => import('../experience-form/experience-form.module').then( m => m.ExperienceFormPageModule)
      },
      {
        path: 'pfe',
        loadChildren: () => import('../pfe/pfe.module').then( m => m.PfePageModule)
      },
      {
        path: 'etat-dossier',
        loadChildren: () => import('../etat-dossier/etat-dossier.module').then( m => m.EtatDossierPageModule)
      },
    ]
  }
];
